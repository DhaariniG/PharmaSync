        ...
        <main class="page-content">
            ...
            <div class="page-head">
                ...
                <div>
                    ...
                    <p>
                        Real-time pharmaceutical stock monitoring and batch management.
                    </p>
                </div>
                ...
                <div class="page-head-actions">
                    ...
                    <a
                        href="<?= BASE_URL ?>/admin/inventory/audit"
            ...
            <div class="callout-critical">
                ...
                <div>
                    ...
                    <div class="b">
                        4 vaccine batches at Warehouse A are reaching expiration
                        within 72 hours. Immediate redistribution or disposal required.
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="<?= BASE_URL ?>/admin/inventory/detail?id=BT-99021-X"
                                    class="icon-btn"
                                    style="border:none;"
                                >
                                    <i data-lucide="eye"></i>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="<?= BASE_URL ?>/admin/inventory/detail?id=BT-11204-Y"
                                    class="icon-btn"
                                    style="border:none;"
                                >
                                    <i data-lucide="eye"></i>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="<?= BASE_URL ?>/admin/inventory/detail?id=BT-55670-Z"
                                    class="icon-btn"
                                    style="border:none;"
                                >
                                    <i data-lucide="eye"></i>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="<?= BASE_URL ?>/admin/inventory/detail?id=BT-88432-A"
                                    class="icon-btn"
                                    style="border:none;"
                                >
                                    <i data-lucide="eye"></i>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="<?= BASE_URL ?>/admin/inventory/detail?id=BT-23419-B"
                                    class="icon-btn"
                                    style="border:none;"
                                >
                                    <i data-lucide="eye"></i>
