    ...
    <main class="page-content">
      ...
      <div class="page-head">
        ...
        <div>
          ...
          <p>
            Manage 24 active vendor partnerships and logistics.
          </p>
        ...
        <div class="page-head-actions">
          ...
          <a
              href="<?= BASE_URL ?>/admin/purchase-orders"
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a
                      href="<?= BASE_URL ?>/admin/suppliers/detail?id=PF"
                      class="icon-btn"
                      style="border:none;"
                  >
              ...
              <tr>
                ...
                <td>
                  ...
                  <a
                      href="<?= BASE_URL ?>/admin/suppliers/detail?id=ME"
                      class="icon-btn"
                      style="border:none;"
                  >
              ...
              <tr>
                ...
                <td>
                  ...
                  <a
                      href="<?= BASE_URL ?>/admin/suppliers/detail?id=AP"
                      class="icon-btn"
                      style="border:none;"
                  >
              ...
              <tr>
                ...
                <td>
                  ...
                  <a
                      href="<?= BASE_URL ?>/admin/suppliers/detail?id=SN"
                      class="icon-btn"
                      style="border:none;"
                  >
          ...
          <div class="po-list">
            ...
            <div class="po-item delayed">
              ...
              <div>
                ...
                <div class="po-sub">
                  SinoPharma &bull; Rs. 13,950,000.00
                </div>
