    ...
    <main class="content">
      ...
      <div class="metric-grid two-col">
        ...
        <div class="metric-card">
          ...
          <div class="metric-bottom">
            <span class="metric-value">$312.00</span>
          </div>
      ...
      <div class="card chart-card">
        ...
        <div class="bars">
          <div class="bar-col"><span class="bar-value">$140</span><div class="bar-fill" style="height:42%"></div><span class="bar-label">MON</span></div>
          <div class="bar-col"><span class="bar-value">$210</span><div class="bar-fill" style="height:63%"></div><span class="bar-label">TUE</span></div>
          <div class="bar-col"><span class="bar-value">$195</span><div class="bar-fill" style="height:58%"></div><span class="bar-label">WED</span></div>
          <div class="bar-col"><span class="bar-value">$280</span><div class="bar-fill" style="height:84%"></div><span class="bar-label">THU</span></div>
          <div class="bar-col"><span class="bar-value">$160</span><div class="bar-fill" style="height:48%"></div><span class="bar-label">FRI</span></div>
          <div class="bar-col"><span class="bar-value">$245</span><div class="bar-fill" style="height:73%"></div><span class="bar-label">SAT</span></div>
          <div class="bar-col"><span class="bar-value">$110</span><div class="bar-fill projected" style="height:33%"></div><span class="bar-label">SUN</span></div>
        </div>
      </div>
      ...
      <div class="lower-grid earnings-grid">
        ...
        <div class="card table-card">
          ...
          <div class="delivery-cards">
            <a class="delivery-card" href="<?= url('/deliveryPartner/order-detail') ?>?id=PH-889021">
              ...
              <div class="delivery-card-row"><span>Base Pay / Tips</span><span>$45.00 &bull; +$12.50</span></div>
            ...
            <a class="delivery-card" href="<?= url('/deliveryPartner/order-detail') ?>?id=PH-889104">
              ...
              <div class="delivery-card-row"><span>Date</span><span>Jun 28, 2024</span></div>
              <div class="delivery-card-row"><span>Base Pay / Tips</span><span>$22.00 &bull; &mdash;</span></div>
            ...
            <a class="delivery-card" href="<?= url('/deliveryPartner/order-detail') ?>?id=PH-888442">
              ...
              <div class="delivery-card-row"><span>Base Pay / Tips</span><span>$65.00 &bull; +$25.00</span></div>
              <div class="delivery-card-row"><span>Status</span><span class="status-badge delivered">Completed</span></div>
            </a>
            <a class="delivery-card" href="<?= url('/deliveryPartner/order-detail') ?>?id=PH-888320">
              ...
              <div class="delivery-card-row"><span>Date</span><span>Jun 27, 2024</span></div>
              <div class="delivery-card-row"><span>Base Pay / Tips</span><span>$18.50 &bull; +$5.00</span></div>
              <div class="delivery-card-row"><span>Status</span><span class="status-badge delivered">Completed</span></div>
            </a>
          </div>
        </div>
        ...
        <div class="earnings-side">
          ...
          <div class="card side-card">
            ...
            <div class="breakdown-list">
              <div class="breakdown-row">
                ...
                <span class="breakdown-value">$845.20</span>
              </div>
              <div class="breakdown-row">
                <span>Tips &amp; Gratuities</span>
                <span class="breakdown-value">$210.30</span>
              </div>
              <div class="breakdown-row">
                <span>Performance Bonuses</span>
                <span class="breakdown-value">$185.00</span>
              </div>
            </div>
          </div>
          ...
          <div class="bonus-banner">
            ...
            <p>You're <strong>$15.00</strong> away from your High Performance weekly bonus!</p>
          </div>
        </div>
